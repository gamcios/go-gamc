...
func (sm *StreamManager) Start() {
	logging.CLog().Info("Starting gamcService StreamManager...")

	go sm.loop()
}

func (sm *StreamManager) loop() {
	logging.CLog().Info("Started gamcService StreamManager.")
...
func (sm *StreamManager) Stop() {
	logging.CLog().Info("Stopping gamcService StreamManager...")
